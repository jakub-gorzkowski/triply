...
const UpdatePlaceModal = ({ isOpen, onClose, onPlaceUpdated, place }) => {
    const [formData, setFormData] = useState({
        name: place.name,
        description: place.description || '',
        address: place.address,
        categoryId: categories.find(c => c.name === place.category)?.id || '',
        photo: null
    });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.name.trim() || !formData.address.trim() || !formData.categoryId) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl w-full max-w-md p-6 relative">
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-6">Edit place</h2>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <span className="text-sm text-gray-500">
                                {formData.photo ? formData.photo.name : 'No new photo selected'}
                            </span>
                            <button
                                type="button"
